...
let rec remove_position_from_annotations (command: Prelude.Ast.Commands.t): Prelude.Ast.Commands.t =
  let newAnnot = {
  ...
  | HeapRegularCommand.Star c -> Prelude.Ast.Commands.annotate (HeapRegularCommand.Star (remove_position_from_annotations c)) newAnnot
  | HeapRegularCommand.Sequence (c1, c2) -> Prelude.Ast.Commands.annotate (HeapRegularCommand.Sequence ((remove_position_from_annotations c1), (remove_position_from_annotations c2))) newAnnot
  | HeapRegularCommand.NondeterministicChoice (c1, c2) -> Prelude.Ast.Commands.annotate (HeapRegularCommand.NondeterministicChoice ((remove_position_from_annotations c1), (remove_position_from_annotations c2))) newAnnot
  | HeapRegularCommand.Command c -> Prelude.Ast.Commands.annotate (HeapRegularCommand.Command (remove_position_from_annotations_atomic c)) newAnnot
...
and remove_position_from_annotations_aexp (aexp: Prelude.Ast.Commands.ArithmeticExpression.t): Prelude.Ast.Commands.ArithmeticExpression.t =
  let newAnnot = {
    Prelude.Ast.position = dummy_position;
...
and remove_position_from_annotations_bexp (bexp: Prelude.Ast.Commands.BooleanExpression.t): Prelude.Ast.Commands.BooleanExpression.t =
  let newAnnot = {
    Prelude.Ast.position = dummy_position;
